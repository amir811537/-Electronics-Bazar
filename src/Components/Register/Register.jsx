        ...
        <div className="relative flex lg:w-1/2 md:w-3/4 mx-auto flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
            ...
            <form onSubmit={handelRegister}>
              ...
              <div className="p-6 pt-0">
                <button
                  className="block w-full select-none rounded-lg bg-gradient-to-tr  from-[#FF5A1D] to-[#333333] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                  type="submit"
                ...
                <p className="mt-6 flex justify-center font-sans text-sm font-light leading-normal text-inherit antialiased">
                  ...
                  <Link className="text-[#ff5a1d] font-bold " to="/login">
                    <p className="pl-2">sign in pease!</p>
                  </Link>
                </p>
              </div>
            </form>
